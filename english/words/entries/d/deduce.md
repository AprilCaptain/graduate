...
| 搭配 | 含义 | 来源记录 |
|---|---|---|
| deduce A from B | 从 B 推断出 A | 2026-07-26-0cb74c4a |
| deduce that... | 推断出…… | 2026-07-26-0cb74c4a |
...
By examining the data, researchers deduced that the change was caused by climate factors.

#### 参考译文

通过分析数据，研究者推断出这一变化是由气候因素导致的。

#### 结构对照

| 英文片段 | 句子作用 | 对应含义 |
|---|---|---|
| By examining the data | 方式状语 | 通过分析数据 |
| researchers deduced | 主句主干 | 研究者推断出 |
| that the change was caused by climate factors | 宾语从句 | 这一变化由气候因素导致 |
